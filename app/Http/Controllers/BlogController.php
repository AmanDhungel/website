...
class BlogController extends BaseController
{
    ...
    {
        try {
            $data['page_url'] = 'blogManagement';
            $data['page_route'] = 'blogManagement';

            $data['results'] = $this->model->getBlogData($request);
            $data['page_title'] = 'Blog Management';
            $data['request'] = $request;
            $data['show_button'] = true;
            $data['filePath'] = Blog::BLOG_PATH;
            $data['load_css'] = [
        ...
        try {
            ...
            if($create){
                if (isset($imageSuccess)) {
                    FileUploadLibraryHelper::setFileUploadPath($request->image, $data['image'], Blog::BLOG_PATH);
                }
            }
