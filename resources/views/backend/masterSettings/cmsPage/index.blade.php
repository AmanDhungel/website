...
@section('content')
    ...
    <div class="content-wrapper">
                                    ...
                                    <div class="card-body">
                                        ...
                                        >
                                            ...
                                            <tr class="{{setFont()}}">
                                                ...
                                                <th>
                                                    Page  {{trans('message.pages.roles.name')}}
                                                </th>
                                            ...
                                            @foreach($results as $key=>$data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if(isset($data->parent->page_name))

                                                            <label class="badge badge-secondary"> {{$data->parent->page_name}}</label>
                                                        @else
                                                ...
                                                @include('backend.masterSettings.cmsPage.edit')
                                            @endforeach
                                            </tbody>
                                        </table>
                                        <span
        ...
        <!-- /.container-fluid -->
        <!-- /.content -->
        @include('backend.masterSettings.cmsPage.add')
