...
@section('content')
    ...
    <div class="content-wrapper">
                                        ...
                                        >
                                            ...
                                            @foreach($results as $key=>$data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img style="width: 20%;" src="{{asset('/storage/uploads/partners/'.$data->icon_image)}}" >
                                                    </td>
                                                ...
                                                @include('backend.partner.edit')
                                                @include('backend.partner.show')
        ...
        <!-- /.container-fluid -->
        <!-- /.content -->
        @include('backend.partner.add')
        @include('backend.modal.technical-error-modal')
        @include('backend.partner.searchModal')
    </div>
